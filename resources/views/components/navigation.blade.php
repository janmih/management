...
<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <x-nav-link-dropdown title="Ressource Humaine" icon="fa-solid fa-people-roof" color="#E26EE5" :route="[route('personnels.index'), route('conge-cumules.index'), route('repos-medicals.index'), route('missions.index'), route('cotisation-socials.index'), route('conge-prises.index'), route('autorisation-absences.index')]" >
            ...
            @endcan
            <x-nav-link-dropdown icon="fas fa-toolbox nav-icon" color="#EBF400" :route="[route('articles.index'), route('etat-stocks.index'), route('demande-articles.index'), route('sortie-articles.index'), route('liste-bons.index')]" title="Gestion de stock">

        ...
        @hasanyrole(['Ressource Humaine|Super Admin'])
            ...
            function openPersonnelModal(action, id = null) {
                ...
                if (action === 'edit') {
                    axios.get('{{ route('personnels.edit', ':id') }}'.replace(':id', id))
                        ...
                        .catch(error => {
                            toastr.error('Une erreur est survenue, veuillez recharger la page');
                            // console.error(error);
                        });
                }
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.delete(`/personnels/${personnelId}`)
                            .then(response => {
                                toastr.success('Personnel supprimé avec succès!');
            ...
            function savePersonnel() {
                ...
                axios({
                    ...
                    .then(response => {
                        toastr.success('Personnel ajouter avec succès!');
                        $('#personnelModal').modal('hide');
                        table.ajax.reload()
